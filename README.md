...
Для полной сдачи по PDF сюда нужно добавить минимум 3 изображения:
- `outputs/screenshots/vm_running.png` — работающая ВМ или контейнер с ботом.
- `outputs/screenshots/code_view.png` — интерфейс кода/ноутбука.
- `outputs/screenshots/llm_success.png` — успешный ответ от LLM.

Если преподаватель просит строгое соответствие, эти изображения должны быть реальными, а не пустыми файлами-заглушками.
